...
const PRODUCT_FORM_KEYWORDS = {
    ...
    shampoo: ["sua tam", "shampoo", "pet shampoo", "deodorizing pet shampoo"],
    wipes: ["wipes", "cleaning wipes", "wet wipes", "pet wipes"],
    litter: ["litter", "cat litter", "bentonite"],
    brush: ["brush", "grooming brush"],
};
