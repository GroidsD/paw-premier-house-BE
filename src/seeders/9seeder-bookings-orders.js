...
const PRODUCTS = [
    {
        ...
        product_name: "Premium Beef Dog Pate",
        variant_label: null,
        sku: null,
    ...
    },
    {
        product_id: 6,
        productVariant_id: null,
        product_name: "Salmon Delight Cat Pate",
        variant_label: null,
        sku: null,
    ...
    },
    {
        product_id: 8,
        productVariant_id: null,
        product_name: "Kitten Nutritional Milk",
        variant_label: null,
        sku: null,
    ...
    },
    {
        product_id: 12,
        productVariant_id: null,
        product_name: "Non-Slip Stainless Steel Bowl",
        variant_label: null,
        sku: null,
    ...
    },
    {
        product_id: 13,
        productVariant_id: null,
        product_name: "Bouncy Rubber Ball",
        variant_label: null,
        sku: null,
    ...
    },
    {
        product_id: 16,
        productVariant_id: null,
        product_name: "Feather Wand Cat Toy",
        variant_label: null,
        sku: null,
    ...
    },
    {
        product_id: 18,
        productVariant_id: null,
        product_name: "Deodorizing Pet Shampoo",
        variant_label: null,
        sku: null,
    ...
    },
    {
        product_id: 19,
        productVariant_id: null,
        product_name: "Pet Cleaning Wipes",
        variant_label: null,
        sku: null,
    ...
    },
    {
        product_id: 20,
        productVariant_id: null,
        product_name: "Double-Sided Grooming Brush",
        variant_label: null,
        sku: null,
    ...
    },
    {
        product_id: 1,
        productVariant_id: 1,
        product_name: "Puppy Care Nutritional Kibble",
    ...
    },
    {
        product_id: 4,
        productVariant_id: 4,
        product_name: "Chicken Dog Treats",
    ...
    },
    {
        product_id: 5,
        productVariant_id: 7,
        product_name: "Adult Tuna Mix Cat Kibble",
    ...
    },
    {
        ...
        product_name: "Premium Leather Pet Collar",
    ...
    },
    {
        ...
        product_name: "Winter Pet Jacket",
...
const ADDRESSES = [
    {
        receiver_name: "Duy Nguyễn",
        receiver_phone: "0901234567",
        receiver_province: "TP. Hồ Chí Minh",
        receiver_district: "Quận 1",
        receiver_address: "123 Nguyễn Trãi, P.2",
    },
    {
        receiver_name: "Thiên Sơn",
        receiver_phone: "0912345678",
        receiver_province: "TP. Hồ Chí Minh",
        receiver_district: "Quận Bình Thạnh",
        receiver_address: "45 Xô Viết Nghệ Tĩnh, P.25",
    },
    {
        receiver_name: "Admin Paw",
        receiver_phone: "0987654321",
        receiver_province: "TP. Hồ Chí Minh",
        receiver_district: "Quận 7",
        receiver_address: "88 Nguyễn Lương Bằng, P.Tân Phú",
    },
    {
        receiver_name: "Duy Nguyễn",
        receiver_phone: "0901234567",
        receiver_province: "Bình Dương",
        receiver_district: "TP. Thủ Dầu Một",
        receiver_address: "10 Đại lộ Bình Dương",
    },
    {
        receiver_name: "Thiên Sơn",
        receiver_phone: "0912345678",
        receiver_province: "Đồng Nai",
        receiver_district: "TP. Biên Hòa",
        receiver_address: "99 Đồng Khởi, P.Tân Hiệp",
    },
    {
        receiver_name: "Minh Châu",
        receiver_phone: "0978563412",
        receiver_province: "TP. Hồ Chí Minh",
        receiver_district: "Quận 3",
        receiver_address: "22 Võ Văn Tần, P.6",
    },
    {
        receiver_name: "Thu Hà",
        receiver_phone: "0965412378",
        receiver_province: "Hà Nội",
        receiver_district: "Quận Hoàn Kiếm",
        receiver_address: "5 Hàng Bài, P.Tràng Tiền",
    },
];
    ...
    async up(queryInterface, Sequelize) {
        ...
        BOOKING_SCENARIOS.forEach(
            (
                ...
                const petId =
                    ownerPets[(petIdRef - 1) % Math.max(ownerPets.length, 1)] ||
                    ownerPets[0] ||
                    null;
                ...
                if (voucherId && VOUCHER_DISCOUNT[voucherId]) {
                    ...
                    if (v.discount_type === "percent") {
                        discount = Math.min(
                            Math.round((originalPrice * v.discount) / 100),
                ...
                // Staff
                const staffId = ["pending", "confirmed"].includes(status)
                    ? null
                    : pick(STAFF_IDS);
                ...
                const cancelledBy =
                    status === "cancelled"
                        ? pick(["customer", "staff", "system"])
                        : null;
                const cancelReason =
                    status === "cancelled"
                        ? pick(CANCEL_REASONS_BOOKING)
                        : null;
                ...
                const row = {
                    ...
                    check_out: checkOut,
                    note: hasNote
                        ? pick(BOOKING_NOTES_POOL.filter(Boolean))
                        : null,
        ...
        insertedBookings.forEach((b) => {
            codeToBookingId[b.booking_code] = b.booking_id;
        });
        ...
        const mkOrderCode = (d) => {
            let c;
            do {
                c = `ORD${ymd(d)}${rand(1000, 9999)}`;
            } while (usedOrderCodes.has(c));
        ...
        ORDER_SCENARIOS.forEach(
            (
                ...
                const selectedProducts = productIndices.map(
                ...
                const originalPrice = selectedProducts.reduce(
                    (sum, prod, i) =>
                        sum + prod.original_price * (selectedQtys[i] || 1),
                    0,
                );
                ...
                const cancelReason =
                    status === "cancelled" ? pick(CANCEL_REASONS_ORDER) : null;
                const expiresAt =
        ...
        insertedOrders.forEach((o) => {
            codeToOrderId[o.order_code] = o.order_id;
        });
