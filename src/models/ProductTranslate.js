...
module.exports = (sequelize, DataTypes) => {
  class ProductTranslate extends Model {
    static associate(models) {
      ProductTranslate.belongsTo(models.Product, { foreignKey: "product_id", as: "product" });
    }
  }

  ProductTranslate.init(
    {
      productTranslate_id: { type: DataTypes.INTEGER, autoIncrement: true, primaryKey: true },
