...
module.exports = (sequelize, DataTypes) => {
  class CategoryTranslate extends Model {
    static associate(models) {
      CategoryTranslate.belongsTo(models.Category, { foreignKey: "category_id", as: "category" });
    }
  }

  CategoryTranslate.init(
    {
      categoryTranslate_id: { type: DataTypes.INTEGER, autoIncrement: true, primaryKey: true },
