...
module.exports = (sequelize, DataTypes) => {
  class ServiceTranslate extends Model {
    static associate(models) {
      ServiceTranslate.belongsTo(models.Service, { foreignKey: "services_id", as: "service" });
    }
  }

  ServiceTranslate.init(
    {
      serviceTranslate_id: { type: DataTypes.INTEGER, autoIncrement: true, primaryKey: true },
